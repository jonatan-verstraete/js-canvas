...
const innerCnvPaddingCanvas = 0
const outerCnvPaddingCanvas = 0
cnv.height = window.innerHeight - outerCnvPaddingCanvas;
cnv.width = window.innerWidth - outerCnvPaddingCanvas;
...
const Ymid = (cnv.height - innerCnvPaddingCanvas) / 2
const Ymax = cnv.height - innerCnvPaddingCanvas
const Ymin = 0 + innerCnvPaddingCanvas

const Xmid = (cnv.width - innerCnvPaddingCanvas) / 2
const Xmax = cnv.width - innerCnvPaddingCanvas
const Xmin = 0 + innerCnvPaddingCanvas
...
function randfloat(a=1, b=0, fixed=3) {
    return toFixed(b ? Math.random()*(b-a+1)+a : Math.random()*(a-b+1)+b, fixed)
