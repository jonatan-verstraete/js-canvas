...
class Point {
    ...
    project() {
       ...
       */
       ...
       this.z = centerSetup.radius * sin(this.phi) * sin(this.theta) + centerSetup.radius
...
class Points {
    ...
    showMovement() {
        ...
        this.points.forEach((i, idx, arr) => {
            ...
            const thisColor = viewSetup.color ? hsl((360/pointsSetup.amount)*i.id||1, 50, 100-100*posInt(i.alpha/2)) : hsl(20,50, 100-100*posInt(i.alpha))
            ...
            if (viewSetup.mode === "points") {
                ...
                if(pointsSetup.afterIamgeCount){
                    i.afterImage.forEach((a, idx, arr)=>{
                        ...
                        const c = viewSetup.color ? hsl((360/pointsSetup.amount)*a.id||1, 50, 100-100*al) : hsl(20,50, 100-100*al)
