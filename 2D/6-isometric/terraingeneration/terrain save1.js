...
tileHeight = 30,
gridSize = 20,
// max y height (landscape height)
maxTileYHeight = 3,
// the resuduel.. sometinhg. inversely proportional with random colors generated
initColCount = 3,
  ...
  setup() {
    ...
    for(let x = 0; x< gridSize; x++)  {
      ...
      for(let y = 0; y< gridSize; y++) {
        row.push({x:x*tileWidth, y:y*tileWidth, v: (y%initColCount ===0 && x%initColCount ===0) ? randint(360) : 0})
      }
      this.grid.push(row)
    }
  }
